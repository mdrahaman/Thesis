...
public class UnfoldingMap implements MapEventListener {
	 ...
	 */
	public void zoomToLevel(double d) {
		float scale = getScaleFromZoom(d);
		setInnerScale(scale);
	}
	 ...
	 */
	public static float getScaleFromZoom(double d) {
		return (float) Math.pow(2.0f, d);
	}
