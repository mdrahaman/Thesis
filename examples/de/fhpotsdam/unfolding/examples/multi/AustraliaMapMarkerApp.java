 ...
 */
public class AustraliaMapMarkerApp extends PApplet {
	...
	public static void main(String args[]) {
		PApplet.main(new String[] { AustraliaMapMarkerApp.class.getName() });
	}
	...
	public void setup() {
		...
		List<Feature> countries = GeoJSONReader.loadData(this, "australia/countries.geo.json");
