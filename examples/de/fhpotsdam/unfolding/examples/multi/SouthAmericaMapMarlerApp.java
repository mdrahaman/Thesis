 ...
 */
public class SouthAmericaMapMarlerApp extends PApplet {
	...
	public static void main(String args[]) {
		PApplet.main(new String[] { SouthAmericaMapMarlerApp.class.getName() });
	}
	...
	public void setup() {
		...
		List<Feature> countries = GeoJSONReader.loadData(this, "southAmerica/countries.geo.json");
