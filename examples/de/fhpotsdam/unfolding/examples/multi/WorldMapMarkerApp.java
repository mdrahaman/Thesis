 ...
 */
public class WorldMapMarkerApp extends PApplet {
	...
	public static void main(String args[]) {
		PApplet.main(new String[] { WorldMapMarkerApp.class.getName() });
	}
	...
	public void setup() {
		...
		List<Feature> countries = GeoJSONReader.loadData(this, "world/countries.geo.json");
