 ...
 */
public class AsiaMapMarkerApp extends PApplet {
	...
	public static void main(String args[]) {
		PApplet.main(new String[] { AsiaMapMarkerApp.class.getName() });
	}

	public void setup() {
		map2 = new UnfoldingMap(this, 0, 50, 1470, 930);
		// map2.zoomToLevel(3);
		Location location1 = new Location(49.456, 87.987);
		map2.zoomAndPanTo(location1, 3);
		MapUtils.createDefaultEventDispatcher(this, map2);

		// map2 = new UnfoldingMap(this, 560, 50, 100, 100);

		List<Feature> countries = GeoJSONReader.loadData(this, "asia/countries.geo.json");
