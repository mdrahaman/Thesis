 ...
 */
public class EuropeMapMarkerApp extends PApplet {
	...
	public static void main(String args[]) {
		PApplet.main(new String[] { EuropeMapMarkerApp.class.getName() });
	}

	public void setup() {
		map2 = new UnfoldingMap(this, 0, 50, 1470, 930);
		// map2.zoomToLevel(3);
		Location location1 = new Location(52.456, 19.987);
		map2.zoomAndPanTo(location1, 4);
		MapUtils.createDefaultEventDispatcher(this, map2);

		// map2 = new UnfoldingMap(this, 560, 50, 100, 100);

		List<Feature> countries = GeoJSONReader.loadData(this, "europe/countries.geo.json");
